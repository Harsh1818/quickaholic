...
<body>
    ...
    <div class="serviceContainer">
        <div id="plumbing" class="serviceBox">
            <div id="plumbingTitleContainer" class="titleContainer">
                ...
                <button type="submit" class="bookNowButton" onclick="location.href='plumbing/index.html'">Book Now!</button>
            </div>
        </div>
    </div>
    <div class="serviceContainer">
        <div id="cleaning" class="serviceBox">
            ...
            <div id="babysittingTitle" class="title">Cleaning</div>
                <button type="submit" class="bookNowButton" onclick="location.href='cleaning/index.html'">Book Now!</button>
            </div>
        </div>
    </div>
    <div class="serviceContainer">
        <div id="babysitting" class="serviceBox">
            <div id="babysittingTitleContainer" class="titleContainer">
                ...
                <button type="submit" class="bookNowButton" onclick="location.href='babysitting/index.html'">Book Now!</button>
            </div>
        </div>
    </div>
    <div class="serviceContainer">
        <div id="laundry" class="serviceBox">
            <div id="laundryTitleContainer" class="titleContainer">
                ...
                <button type="submit" class="bookNowButton" onclick="location.href='laundry/index.html'">Book Now!</button>
            </div>
        </div>
    </div>
    <div class="serviceContainer">
        <div id="chefCook" class="serviceBox">
            <div id="chefCookTitleContainer" class="titleContainer">
                ...
                <button type="submit" class="bookNowButton" onclick="location.href='cook/index.html'">Book Now!</button>
            </div>
        </div>
    </div>
    <div class="serviceContainer">
        <div id="electrician" class="serviceBox">
            <div id="electricianTitleContainer" class="titleContainer">
                ...
                <button type="submit" class="bookNowButton" onclick="location.href='electrician/index.html'">Book Now!</button>
            </div>
        </div>
    </div>
    <div id="dashboardFooter" class="footer">
        ...
        <div id="dashboardFooterButtons">
            <button type="submit" class="footerButtons" onclick="location.href='service.html'">Help</button>
            <button type="submit" class="footerButtons" onclick="location.href='contact.html'">Contact Us</button>
            <button type="submit" class="footerButtons" onclick="location.href='about.html'">About</button>
